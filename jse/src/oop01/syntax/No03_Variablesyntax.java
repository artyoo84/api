...
There are several kinds of variables.abstract
*/
/*
...
*/
// 멤버 변수는 클래스 변수와 인스턴스 변수를 통틀어서 부르는 말이다. 
/*
변수의 종류
- 클래스 변수 ( 클래스 영역, 클래스가 메모리에 올라갈 때 가장 먼저 생성) static 
- 인스턴스 변수 (클래스 영역, 인스턴스 생성시 생성)
- 로컬 변수 (지역변수, 메소드 영역, 변수 선언문 수행시 생성) // 저장소 스텍
*/
/*
인스턴스 변수?
- 1. 각 인스턴스의 개별적인 저장공간
